...
const oldGemini = `        // 使用 Google Gemini API
...
const newGemini = `        // 使用 Google Gemini API (改用 OpenAI 相容模式，並指定 gemini-3.1-flash，若失敗會嘗試降級)
...
console.log('patched gemini to openai compatible endpoint');